...
export interface BookRecordEditMemoProps {
  text?: string;
}

export default function BookRecordEditMemo(props: BookRecordEditMemoProps) {
  const { text } = props;
    ...
    <Stack className=" w-full h-full">
      ...
      <Stack className=" flex-grow h-full bg-white-yellow">
        ...
        <Flex className=" px-[16px] mb-[24px]">
          <CtaButton onClick={() => alert("hello")}>다 적었어요</CtaButton>
        </Flex>
      </Stack>
    </Stack>
  );
